export const FAQ_QUESTIONS: Record<string, { question: string; answer: string }> = {
  ...
  3: {
    ...
    answer: `This project is led by the Open Contracting Partnership in conjunction with Strive Community, a global philanthropic initiative launched by the Mastercard Center for Inclusive Growth and Caribou Digital, which aims to support 5 million small businesses globally to build resilience and grow. We have partnered with Colombian financial entities to provide offers of credit options.`,
  },
  4: {
    question: 'What happens if my credit application is rejected?',
    answer: `If your application is rejected you will have the opportunity to submit a new application if other financial products are available on the platform.`,
  },
  5: {
    question: 'What if I have concerns about data privacy and protection?',
    answer: `Please refer to Credere terms of use. You can write to credere@open-contracting.org with any additional questions.`,
  },
};
